    ...
    try {
        ...
        nodemailer.createTestAccount((err, account) => {
            ...
            let mailOptions = {
                ...
                subject: `Your Next Steps to Sell On Marketplace`, // Subject line
...
exports.registrationRejection=async function(email,role,name, message){
    ...
    nodemailer.createTestAccount((err, account) => {
            ...
            let mailOptions = {
                from: '"Senorcoders" <milton@senorcoders.com>', // sender address
                to: email, // list of receivers
                subject: `Update - Marketplace Account`, // Subject line
                text: '', // plain text body
                html: template, // html body
                attachments: [{
                    filename: 'logo.png',
    ...
    try {
        ...
        nodemailer.createTestAccount((err, account) => {
            ...
            let mailOptions = {
                from: '"Senorcoders" <milton@senorcoders.com>', // sender address
                to: email, // list of receivers
                subject: `Welcome Onboard, Getting Started with Marketplace !`, // Subject line
                text: '', // plain text body
                html: template, // html body
                attachments: [{
                    filename: 'logo.png',
    ...
    try {
        ...
        nodemailer.createTestAccount((err, account) => {
            ...
            let mailOptions = {
                ...
                subject: `Registration Denied - Marketplace`, // Subject line
                text: '', // plain text body
                html: template, // html body
                attachments: [{
                    filename: 'logo.png',
...
function getTemplateUserRevision(id, code,name) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        <a href="https://platform.senorcoders.com/verification/${id + '/' + code}" target="_blank" style="display: block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #D61A1A; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; max-width: 200px; width: 160px;width: auto; border-top: 0px solid transparent; border-right: 0px solid transparent; border-bottom: 0px solid transparent; border-left: 0px solid transparent; padding-top: 5px; padding-right: 20px; padding-bottom: 5px; padding-left: 20px; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif;mso-border-alt: none">
        ...
        <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;"><![endif]-->
        <div style="color:#555555;line-height:150%;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">  
        <div style="font-size:12px;line-height:18px;color:#555555;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 21px"><span style="font-size: 15px; line-height: 22px;color:black">If there are any problems with the button, just copy and paste this link in your browser address bar:</span></p><p style="margin: 0;font-size: 14px;line-height: 21px"><span style="font-size: 15px; line-height: 22px; color: rgb(0, 0, 255);">https://platform.senorcoders.com/verification/${id + '/' + code}</span></p><p style="margin: 0;font-size: 14px;line-height: 21px"><span style="font-size: 15px; line-height: 22px;color:black">For the meanwhile please have a look at our <a href="https://platform.senorcoders.com/guides" style="font-size: 15px; line-height: 22px; color: rgb(0, 0, 255);">Marketplace guide</a> to familiarize yourself with our platform and services.</p></div>    
        </div>
    `;
...
exports.registerUser = async function (fullName, email, password, verificationCode) {
    ...
    let mailOptions = {
        ...
        text: '',
        html: '<b>Does not have the apk, enter the website, click </b><a href="https://platform.senorcoders.com/">here</a>' // html body
    };
...
exports.sendEmailForgotPassword = function (email, code) {
    ...
    nodemailer.createTestAccount((err, account) => {
        ...
        let mailOptions = {
            from: '"Senorcoders" <milton@senorcoders.com>', // sender address
            to: email, // list of receivers
            subject: 'Password Recovery for Marketplace', // Subject line
            text: '', // plain text body
            html: template,
            attachments: [{
                filename: 'image.png',
    ...
    return new Promise((resolve, reject) => {
        ...
        nodemailer.createTestAccount((err) => {
            ...
            let mailOptions = {
                from: '"Senorcoders" <milton@senorcoders.com>', // sender address
                to: email, // list of receivers
                subject: 'New Message of Contact in Marketplace', // Subject line
                text: '', // plain text body
                html: `
...
async function getTemplateShopping(items,cart,orderNumber,storeName) {
    ...
    let subtotal=cart.total.toFixed(4);//+shipping+otherTaxes;
...
exports.sendCartSeller = async function (fullName, fullNameBuyer, emailBuyer, items, email) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        let mailOptions = {
            from: '"Senorcoders" <milton@senorcoders.com>', // sender address
            to: email, // list of receivers
            subject: 'Shopping at Marketplace', // Subject line
            text: '',
            html: template
        };
